...
| --- | --- | --- | --- |
| `中国风，萧.svg` | instrument motif | contain | Optional cultural accent. |
...
| `古风物件，中国风，中国结 (1).svg` | knot ornament | contain | Alternate knot asset. |
| `古风物件，中国风，铜钱，圆形方孔钱2.svg` | coin motif | contain | Finance or historical accent only. |
| `古风物件，中国风，古代兵器，刀，环首刀.svg` | weapon motif | contain | Use only when topic-appropriate. |
