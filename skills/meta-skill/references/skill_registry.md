...
| `tutorial-learning` | `skills/tutorial-learning/` | workflow | experimental | Converts PDF, HTML, Markdown, and web tutorial sources into medium-neutral, source-traced Chinese route-overview or chapter-tutorial design bundles. | PDF textbook, HTML tutorial, Markdown guide, web tutorial, chapter study, section lecture, triage, micro-assessment, review cards. | Personalized routes, evidence-gated lesson designs, Chinese lecture markdown, diagnostic assessments, practice, review plans, and fidelity evidence. | Raw PDF rendering and OCR belong to document tooling; HTML, PPT, H5, DOCX, visual style, and runtime persistence belong to downstream renderers. | Instructional-design intermediate layer only. |
