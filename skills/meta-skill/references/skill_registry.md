...
| `tutorial-learning` | `skills/tutorial-learning/` | workflow | experimental | Converts PDF, HTML, Markdown, and web tutorial hypertext sources into source-traced Chinese learning and review artifacts. | PDF textbook, HTML tutorial, Markdown guide, web tutorial, chapter study, section lecture, triage, micro-assessment, review cards. | Chinese lecture markdown, source-traced triage, practice tasks, micro-assessments, review plans, H5/hypertext projection stubs. | Repository skill governance belongs to `meta-skill`; raw PDF rendering/OCR belongs to document tooling; non-hypertext carriers are out of scope. | Single active implementation: `hypertext-tutorial`. |
