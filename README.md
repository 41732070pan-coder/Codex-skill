...
| `professional-tutorial-learning` | 业务 Skill / 学习工作流 | `skills/professional-tutorial-learning/` | 将 PDF、网页课程、视频转录或专业教程转成分节 Markdown 讲义、知识点图、练习、检查题和复习计划，并保留未来 Web 学习应用可渲染的数据边界。 | experimental |
